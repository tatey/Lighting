...
class LightTargetControlView: NSView {
    ...
    override func rightMouseUp(with theEvent: NSEvent) {
        ...
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.incandescent)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.warm)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.neutralWarm)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.neutral)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.cool)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.coolDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.softDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.daylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.noonDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.brightDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.cloudyDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.blueDaylight)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.blueOvercast)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.blueWater)))
        whitesMenu.addItem(colorItemFor(ColorMap.valueForKey(.blueIce)))
